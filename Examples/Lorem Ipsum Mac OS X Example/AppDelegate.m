...
{
    [self.mainView addSubview:self.imagesViewController.view];
    NSDictionary *views = @{@"imagesView": self.imagesViewController.view};
    [self.mainView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[imagesView]|" options:0 metrics:nil views:views]];
    [self.mainView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[imagesView]|" options:0 metrics:nil views:views]];
